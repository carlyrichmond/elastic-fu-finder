...
export function BadgeCoin(props: BadgeCoinProps) {
  ...
  return (
    <div className={styles['badge-container']} data-testid='badge-coin' title={props.badge.name}>
      <svg xmlns="http://www.w3.org/2000/svg" width="2.5rem" height="2.5rem" fill="currentColor" className={styles['bi-coin']} viewBox="0 0 16 16"> 
